/**
 * Standalone deploy script for the equity-registry contract.
 *
 * Usage:
 *   npm run build && npm run deploy
 *
 * Deploy the equity registry contract for managing startup equity stakes on-chain
 * with privacy-preserving cap table details.
 */
...
async function main() {
  ...
  console.log('\n╔══════════════════════════════════════════════════════════╗');
  console.log('║      Anonymous Startup Equity Registry Deploy Script    ║');
  ...
  // --- Deploy ---
  const contract = await withStatus('Deploying equity-registry contract (this may take a few minutes)', async () => {
